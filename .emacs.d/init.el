...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dockerfile-mode code-review forge terraform-mode yaml-mode quick-peek flycheck color-theme-sanityinc-tomorrow beacon smex rainbow-delimiters paredit magit cider))
